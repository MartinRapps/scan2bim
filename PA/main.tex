...
\newcommand{\thwsSubmissionDate}{04.09.2026}
...
\vspace{0.5em}
\noindent\begin{tabular}{@{}p{2.0cm}p{4.2cm}p{3.0cm}l@{}}
Name: & Rapps & Vorname: & Martin\\[0.4em]
Matr.Nr.: & 6323014 & & \\[0.4em]
Adresse: & \dotfill & & \\[0.4em]
E-Mail: & \dotfill & Studiengang: & B.\,Eng.\ Geovisualisierung\\
\end{tabular}
...
\begin{itemize}[leftmargin=1.4em,itemsep=2pt]
  ...
  \item meine persönlichen Daten (Vorname, Name, studentische E-Mail-Adresse)
...
\fi
\section*{Kurzfassung}
Diese Projektarbeit untersucht die technische Machbarkeit einer Docker-basierten Pipeline zur
...
Die Pipeline wurde anhand eines Videodatensatzes eines Aluminiumrohrs durchgängig
überprüft: Untersucht wurden die vollständige SfM-Kameraregistrierung (240 von 240
Bildern), die Rekonstruktionsqualität im Vergleich verschiedener Kamera-,
Bildraten- und Auflösungskonfigurationen sowie die Verlässlichkeit der Mesh- und
Mittellinienextraktion. Für die Produktionskonfiguration (OPENCV, 5~FPS, 720p,
Route A) werden 29,62\,dB objektmaskierte PSNR erreicht. Der Schwerpunkt liegt
auf der technischen Funktionsfähigkeit, der sauberen Trennung von Bilddomänen
und der reproduzierbaren Auswertung. Die Arbeit ist ein Machbarkeitsnachweis für die spätere
