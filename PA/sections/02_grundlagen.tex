...
Skript \texttt{run\_sfm.sh} übergibt COLMAP lediglich die Modellfamilie und über
den Parameter \path{ImageReader.single_camera=1} die Annahme eines gemeinsamen
